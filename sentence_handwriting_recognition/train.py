...
from modules.losses import CTCloss
from modules.callbacks import Model2onnx, TrainLogger
from modules.metrics import CERMetric, WERMetric

try: [tf.config.experimental.set_memory_growth(gpu, True) for gpu in tf.config.experimental.list_physical_devices("GPU")]
except: pass

sentences_txt_path = os.path.join("Datasets", "IAM_Sentences", "sentences.txt")
...
# Augment training data with random brightnes and erode/dilate
